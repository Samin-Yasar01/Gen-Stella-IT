  ...
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {members.map((m) => (
        <div
          key={m.id}
          className="rounded-2xl border border-gray-200/70 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm p-6 text-sm flex flex-col items-center text-center"
        >
          ...
          <div className="font-semibold text-gray-900 dark:text-white text-lg">{m.name}</div>
